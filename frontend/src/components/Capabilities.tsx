import { Monitor, Database, Cloud, Lock, Users, Settings } from 'lucide-react';
...
const capabilities = [
	{
		...
		description:
			'Access a wide variety of data sources supported by Grafana Enterprise and connect to your data stores in Azure and elsewhere.',
	...
	},
	{
		...
		description:
			'Share Grafana dashboards with people inside and outside of your organization. Allow others to contribute to solution monitoring.',
	...
	},
	{
		...
		description:
			'Centralize identity management in Microsoft Entra ID. Control which users can use a Grafana instance and leverage managed identities.',
	...
	},
	{
		...
		description:
			'Microsoft invests more than $1 billion annually on cybersecurity research and development with 3,500+ security experts.',
	...
	},
	{
		...
		description:
			'Focus on insights, not infrastructure. Azure handles deployment, scaling, updates, and maintenance automatically.',
