			...
			<div className="w-full px-4 sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						Azure Managed Grafana pricing is based on the number of active users
						and hosting infrastructure costs. Try the service with a 30-day free
						trial.
					</p>
				</div>
				...
				<div className="mt-16 text-center">
					<p className="text-gray-600 mb-4">
						Get started with an Azure free account. No credit card required for
						trial.
					</p>
